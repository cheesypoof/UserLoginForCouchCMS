...
>
	<cms:if k_error>
		<div class="alert alert-error">An unknown error occured which prevented account creation. Please contact us if this error persists.</div>
	<cms:else/>
...
Please visit this link to activate your account: <cms:link 'account.php'/>?activate=1&amp;id=<cms:show k_last_insert_id/>&amp;hash=<cms:show activation_hash/>
