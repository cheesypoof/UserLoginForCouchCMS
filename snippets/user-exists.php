...
<cms:else/>
	<cms:set exists_user_name="<cms:pages count_only='1' custom_field="user_name==<cms:show frm_user_name/>" masterpage='users.php'/>"/>
...
<cms:else/>
	<cms:set exists_user_email="<cms:pages count_only='1' custom_field="user_email==<cms:show frm_email/>" masterpage='users.php'/>"/>
